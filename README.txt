...
3. The projuct can be started in debug mode now
4. For unit testing, you can right click the PokerGame.Tests project, and Run Tests, or use the "Test" menu option at the top of visual studio and select "Run all tests"
